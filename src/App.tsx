...
function App() {
  const [quote, setQuote] = useState<Quote>(getRandomQoute());
  ...
  return (
    <div className='background' style={{ backgroundColor: randomColor, transition }}>
      <div id="quote-box">
        ...
        <a href={`twitter.com/intent/tweet`} id='tweet-quote' style={{backgroundColor: randomColor, transition, marginRight: "10px"}}>
